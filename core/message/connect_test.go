...
func TestConnectMessageDecode(t *testing.T) {
	...
	require.Equal(t, "goflymq", string(msg.ClientId()), "Incorrect client ID value.")
	...
	require.Equal(t, "goflymq", string(msg.Username()), "Incorrect username value.")
	require.Equal(t, "goflypw", string(msg.Password()), "Incorrect password value.")
}
