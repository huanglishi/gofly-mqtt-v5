...
//
//import (
//	"github.com/huanglishi/gofly-mqttv5/corev5/topicsv5/impl"
//	"testing"
//
...
//			tl, rem, err = impl.nextTopicLevel(rem)
...
//	)
//
//	_, rem, err = impl.nextTopicLevel(topics[0])
//	require.NoError(t, err)
//
//	_, rem, err = impl.nextTopicLevel(rem)
//	require.Error(t, err)
//
//	_, rem, err = impl.nextTopicLevel(topics[1])
//	require.NoError(t, err)
//
//	_, rem, err = impl.nextTopicLevel(rem)
//	require.NoError(t, err)
...
//	require.Error(t, err)
//
//	_, rem, err = impl.nextTopicLevel(topics[2])
//	require.Error(t, err)
//}
//
...
//	Unregister("mem")
//	p := impl.NewMemProvider()
//	Register("mem", p)
//
//	mgr, err := NewManager("mem")
//
//	impl.MaxQosAllowed = 1
